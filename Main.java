...
class Main {
  public static void main(String[] args) {
    ...
    System.out.println("sum of num[0] and num[1] = "+sum);
    nums[5]=nums[5]*2;
    ...
    while(index<candy.length)
    {
      ...
      //if only one word, you just put it.next();
    ...
    //String words[]={"Have","a","nice","day"};
    //first is the preferred way, but you would not be wrong with the second
    int indexWhere2=-1;
    ...
    if(indexWhere2!=-1)
     {
       System.out.println("Nice has been found at "+indexWhere2);
     } else{
       System.out.println("Nice has not been found");
    }
    ...
    for(int index=0;index<words.length;index++)
    {
      //be careful when to put length()--For Strings
